...
void SceneManager::SetupSceneLights()
{
	...
	//m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 1.0f, 0.0f, 0.0f);
	//m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.0f, 0.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.1f, 0.2f, 0.1f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.00f, 0.00f, 2.00f);
...
void SceneManager::RenderScene()
{
	...
	scaleXYZ = glm::vec3(0.0f, 0.0f, 0.0f);
...
SetShaderTexture("taperedCylinder");

// draw the mesh with transformation values
m_basicMeshes->DrawTaperedCylinder();
/****************************************************************/
}
	/*** Set needed transformations before drawing the basic mesh.  ***/
	/*** This same ordering of code should be used for transforming ***/
